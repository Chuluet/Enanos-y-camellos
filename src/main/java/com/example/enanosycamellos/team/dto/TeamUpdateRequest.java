...
@Schema(description = "Fields to modify of a team. Those not sent are left unchanged.")
public record TeamUpdateRequest(

        @Size(min = 2, max = 100, message = "name must be between 2 and 100 characters")
        @Schema(description = "New name", example = "Isaac cancele")
        String name,
        ...
        @Schema(description = "New coach", example = "Ms. Pardo")
        String coach,
